...
\title{两性仿生抗污染肽的机理研究及应用}
%\author{唐磊}
\author[李传玺]{(申请天津大学工学博士学位论文答辩报告)\vskip 20pt学~~~~~~生：李~~传~~玺~~~~~~~~\vskip 5pt 指导教师：刘~春~江~教授~~苏~荣~欣~教授}
\institute[天津大学~化工学院~\&~化学工程重点实验室]{\small \vskip 38pt化工学院}
%\date{2015-06-07}
...
\begin{figure}[htbp]
  \begin{center}
	\includegraphics[width=0.16\linewidth]{TJU_logo}
  \end{center}
\end{figure}
%\beign{picture}(1,1)
